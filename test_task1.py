...
# -*- coding: utf-8 -*-
"""
ENGG1811 Assignment 2: Optimising Test 1 Results/Speed
"""
import time
import pickle
import numpy as np
...
if ( err_ys < TOL ):
    print("ys: Test Passed, Accurate Results!")
else :
    print("ys: Test Failed! Need to Reconsider Code!")
    print("ys: Max difference in ys values: " + str(err_ys))
    
if ( err_yu < TOL ):
    print("yu: Test Passed, Accurate Results!")
else :
    print("yu: Test Failed! Need to Reconsider Code!")
    print("yu: Max difference in yu values: " + str(err_yu))

if ( err_vs < TOL ):
    print("vs: Test Passed, Accurate Results!")
else :
    print("vs: Test Failed! Need to Reconsider Code!")
    print("vs: Max difference in vs values: " + str(err_vs))  
if ( err_vu < TOL ):
    print("yu: Test Passed, Accurate Results!")
else :
    print("vu: Test Failed! Need to Reconsider Code!")
